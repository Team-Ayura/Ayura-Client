...
class CyclingOnRideAltPage extends StatefulWidget {
  CyclingOnRideAltPage({Key? key}) : super(key: key);

  @override
  State<CyclingOnRideAltPage> createState() => _CyclingOnRideAltPageState();
}

class _CyclingOnRideAltPageState extends State<CyclingOnRideAltPage> {
