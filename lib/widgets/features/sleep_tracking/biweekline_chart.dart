...
class BiWeeklyChart extends StatefulWidget {
  const BiWeeklyChart({super.key});

  @override
  State<BiWeeklyChart> createState() => _BiWeeklyChartState();
}

class _BiWeeklyChartState extends State<BiWeeklyChart> {
  @override
